...
class NavigationTask(EmbodiedTask):
    def __init__(
        self, config: Config, sim: Simulator, dataset: Optional[Dataset] = None, group_id=None, agent_id=None
    ) -> None:
        super().__init__(config=config, sim=sim, dataset=dataset, group_id=group_id, agent_id=agent_id)
